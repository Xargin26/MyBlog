...
{
    public abstract class MyBlogWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyBlogWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyBlogWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyBlogDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyBlogDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyBlogDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyBlogDbContext, Task<T>> func)
        {
            T result;
